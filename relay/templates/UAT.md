...
Template for `.relay/tickets/XX-name/{phase}-UAT.md` — persistent UAT session tracking.
...
- This section feeds directly into /relay:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /relay:plan-phase --gaps with root causes
...
- truth: "Comment appears immediately after submission"
  ...
  debug_session: ".relay/debug/comment-not-refreshing.md"
```
...
**Creation:** When /relay:verify-work starts new session
