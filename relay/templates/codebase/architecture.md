...
Template for `.relay/codebase/ARCHITECTURE.md` - captures conceptual code organization.
...
**State Management:**
- File-based: All state lives in `.relay/` directory
...
- Triggers: User runs `relay <command>`
