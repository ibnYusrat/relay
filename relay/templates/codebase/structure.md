...
Template for `.relay/codebase/STRUCTURE.md` - captures physical file organization.
...
│   └── relay/          # Relay-specific commands
├── relay/     # Skill resources
...
**relay/templates/**
- Purpose: Document templates for .relay/ files
...
**New Slash Command:**
- Primary code: `commands/relay/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `relay/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `relay/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/relay/workflows/{name}.md`

**New Reference Document:**
- Implementation: `relay/references/{name}.md`
