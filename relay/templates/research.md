...
Template for `.relay/tickets/XX-name/{phase}-RESEARCH.md` - comprehensive ecosystem research before planning.
...
**CRITICAL:** If CONTEXT.md exists from /relay:discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**Structure:**
- Use XML tags for section markers (matches Relay templates)
...
**After creation:**
- File lives in phase directory: `.relay/tickets/XX-name/{phase}-RESEARCH.md`
