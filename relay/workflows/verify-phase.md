...
<required_reading>
@~/.claude/relay/references/verification-patterns.md
@~/.claude/relay/templates/verification-report.md
</required_reading>
...
<!-- Goal-backward derivation expertise is baked into the relay-verifier agent -->
</step>
...
See ~/.claude/relay/templates/verification-report.md for complete template.
</step>
